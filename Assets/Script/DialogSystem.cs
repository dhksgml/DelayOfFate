...
public enum Speaker { Player = 0, Seller1, Seller2}
...
public class DialogSystem : MonoBehaviour
{
	...
	[SerializeField]
	private Image[] imagePortrait;                        // 현재 대사중인 캐릭터 이름 출력 Text UI
	[SerializeField]
	...
	private void SetNextDialog()
	{
		...
		imagePortrait[(int)currentSpeaker].gameObject.SetActive(true);
	...
	private void InActiveObjects(int index)
	{
		...
		imagePortrait[index].gameObject.SetActive(false);
